/*
 * Copyright (c) 2003-2018 by Objective Systems, Inc.
 *
...
typedef struct OSMemBlk {
   OSMemLink      link;
   /* 14-04-03 MEM:  The 8-byte multiplier is used, I think, because the
    * links in OSMemLink are memory addresses that are eight bytes wide.
    * The firstFree item says that we need to advance 8*firstFree bytes before
    * we'll find the first free address in the list. */
